...
| YN slot mapping (BKYSMSTR) | 🔄 Partial | 88/100 | 101 slots confirmed total: 91 Frida+DFM+SRC (Pass 575c) + 10 DBA.LIB functional descriptions (Pass 575d: YN[205]=APOn, YN[206]=AROn, YN[209-215]=GL posting flags, YN[224]=AR2001 stage); suwin6t.rwn.dec structure mapped (472 × 77B ISTS.CFG entries at 0xb21d; YN slot not stored inline; no text BKYSMSTR refs); ~149 slots unknown; **blocker: ISTS.GET compiled into suwin6t — bytecode spec required; next: Frida 05d or Ghidra tp7runtime.exe** |
