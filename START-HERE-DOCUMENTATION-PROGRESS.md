...
| YN slot mapping (BKYSMSTR) | 🔄 Partial | 88/100 | 250-slot live snapshot complete; all 85 T7MDefNDC.DFM direct bindings confirmed via hierarchical parser (Pass 572); 20+ positional errors corrected; YN[102-143]=42 module-enable slots (BKMENUSU GROUPS order, two-company confirmed Pass 571); Z/1/space confirmed generic tier flags; YN[150-198]=all empty; ~162 slots still unknown |
