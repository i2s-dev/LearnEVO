...
| YN[23] | INV BOM | Require Sequence Entry - Type N (Non Inventory)? [Y/N] | unknown | T7MDefNDC.DFM direct binding (Pass 572) |
...
| YN[50] | INV Setup | Average, FIFO, LIFO or Standard Costing? (A/F/L/S) — live='A' (Average) | unknown | T7MDefNDC.DFM direct binding (Pass 572) |
...
| YN[78] | PO Printing | RFQ Print Format Number — live='2' (prior positional said "PO form format" but direct binding says RFQ; live='2'=RFQ2 or POE2) | unknown | T7MDefNDC.DFM direct binding (Pass 572) |
| YN[79] | Contact Master | Prompt for save in Enter Accounts? [Y/N] | unknown | T7MDefNDC.DFM direct binding (Pass 572) |
| YN[80] | PO Printing | Print Co. Name/Address on forms? [Y/N] | unknown | T7MDefNDC.DFM direct binding (Pass 572) |
| YN[82] | WO Printing | Print Multi Routing? [Y/N] | unknown | T7MDefNDC.DFM direct binding (Pass 572) |
| YN[83] | PO Processing | Require Pack Slip Info? [Y/N] | unknown | T7MDefNDC.DFM direct binding (Pass 572) |
| YN[84] | PO Processing | Receive all lines? [Y/N] | unknown | T7MDefNDC.DFM direct binding (Pass 572) |
| YN[85] | PO Processing | Display comment lines? | unknown | T7MDefNDC.DFM direct binding (Pass 572) |
| YN[86] | PO Processing | Display fully received lines? [Y/N] | unknown | T7MDefNDC.DFM direct binding (Pass 572) |
| YN[87] | Acct. Receivables | Print Co. Name/Addr on Statement [Y/N] | unknown | T7MDefNDC.DFM direct binding (Pass 572) — CRHOLD reassigned (prior assignment was wrong) |
| YN[200] | WO Scheduling | Use Lead Time Scheduling [F/B/N] — live='N' (none) | unknown | T7MDefNDC.DFM direct binding (Pass 572) |
| YN[202] | WO Processing | Use Projected or Estimate $ and Hrs [P/E]? | unknown | T7MDefNDC.DFM direct binding (Pass 572) |
...
| YN[218] | DC Setup | Enable Employee Shift Start/Stop? [Y/N] | unknown | T7MDefNDC.DFM direct binding (Pass 572) |
| YN[220] | WO Printing | Print Routing Seq Order (A/D) | unknown | T7MDefNDC.DFM direct binding (Pass 572) |
| YN[222] | PO Setup | GL Department — Allow/No/Require (Y/N/R) | unknown | T7MDefNDC.DFM direct binding (Pass 572) |
| YN[223] | PO Setup | Location — Allow/No/Require (Y/N/R) | unknown | T7MDefNDC.DFM direct binding (Pass 572) |
| YN[225] | SO Processing | SO-E: Release Qtys > On hand (0/1/2/3) | unknown | DFM positional |
| YN[228] | DC Setup | Use full Screen? (Y=mount BKDCAF alternate/full screen) | ISTS.CFG.DCSEQ | T7MDefNDC.DFM direct binding + SRC (BKDCA.SRC:193-201) (Pass 572) |
| YN[229] | DC Setup | Allow clocking in/out on multiple jobs? (Y=prompt "Continue same employee?") | ISTS.CFG.DCSYNC | T7MDefNDC.DFM direct binding + SRC (BKDCA.SRC:228-239) (Pass 572) |
| YN[230] | Acct. Receivables | Invoice Age based on (1) age or (2) days past due [1/2] | unknown | T7MDefNDC.DFM direct binding — full label confirmed (Pass 572) |
| YN[231] | SO Setup | Suppress Non-Tax warning message? [Y/N] | unknown | T7MDefNDC.DFM direct binding (Pass 572) |
| YN[237] | WO Scheduling | PO & DC update the actual start/finish dates of sequences? | unknown | DFM positional |
| YN[238] | SO Setup | Allow/Require Entry to Department [Y/N/R] | unknown | T7MDefNDC.DFM direct binding (Pass 572) |
| YN[239] | SO Setup | Allow/Require Entry to Location [Y/N/R] | unknown | T7MDefNDC.DFM direct binding (Pass 572) |
| YN[240] | Estimates | Print Title on Quote? [Y/N] | unknown | T7MDefNDC.DFM direct binding (Pass 572) — CMEST reassigned (prior assignment was wrong) |
| YN[241] | PO Printing | Print Title on RFQ? [Y/N] | unknown | T7MDefNDC.DFM direct binding (Pass 572) |
| YN[242] | PO Printing | Print Title on PO? [Y/N] | unknown | T7MDefNDC.DFM direct binding (Pass 572) |
...
| YN[247] | Acct. Receivables | Print Title on Statement [Y/N] | unknown | T7MDefNDC.DFM direct binding (Pass 572) |
| YN[248] | MRP | Round MRP quantities to the next whole number? [Y/N] | unknown | T7MDefNDC.DFM direct binding (Pass 572) — MRPDAY reassigned (prior assignment was wrong) |
...
**T7MDefNDC.DFM direct binding corrections (Pass 571/572):** The older T7MDefNDC.DFM (April 2018) has DIRECT FieldName='BKYS.YN[N]' bindings on all 85 configurable slots, bypassing positional inference. Where these conflict with T7MDEFAULTS.DFM positional results, the direct binding takes precedence.
- **GL Setup block reversed (Pass 571):** YN[209/212/213/214/215] were labeled in REVERSE order by positional; direct binding shows: 215=COGS, 214=PO, 213=INV ADJ, 212=WO, 209=Item Class GLs.
- **SOPrint tab swapped (Pass 571):** positional mixed up “format number” format-selector combos (YN[76/39/77]) with Y/N entry fields. Direct binding: YN[62]=Decimalized Qty, YN[74]=Print Discount Column; YN[243-246]=Print Title on SO forms (Quotes/Invoices/PackSlips/Acks).
...
YN[36]='D' (M/D choice), YN[39/76/77/78]=(SO/PO format numbers 1–5),
YN[47/48]=(form/check format 1–5), YN[50]='A/F/L/S' (costing method), YN[200]='F/B/N' (schedule mode),
YN[225]='0/1/2' (release mode), YN[230]='1/2' (age basis), YN[249]=(pixels).
