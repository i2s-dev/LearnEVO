...
| `.UPD` | 9     | **EvoERP proprietary Btrieve dictionary** (FC magic, 4096-byte pages) — FILELOC/FILEDICT/FILEKEY/etc. are live runtime lookup tables + migration targets | **Partially** (Pass 409: 3,265 field pairs extracted from FILEDICT; 1,352 routing records from FILELOC) | [fl-file-location.md](../03-modules/fl-file-location.md) |
