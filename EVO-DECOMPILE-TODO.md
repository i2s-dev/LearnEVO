...
| Module: IN/Inventory | **96** | 85 | **0** ✅ Pass170 T7INB(466p): BKIC.PROD.*(63)+LOC.*(33+11new)+LOCM.*(15)+REF.*(12new) + MTIC.PROD.*(57) + MTIT.*(34/INVTXN) + MTOOL.*(39/mold) + MTWC.*(30) + ISCC.ICM.*(53/upholstery custom); Pass172 T7ING(323p): JGP.*(58/JGPITEMS consumer goods catalog—retail packaging hierarchy+ALLERGEN+ISBN+ASTM+MIN.AGE+TARRIF.CODE) | 2026-06-22 |
| Module: SO | **97** | 85 | **0** ✅ Pass169 T7SOA(606p) var-confirm: BKAR.* 73 customer vars + BKAR.INVT.* 25 + BKAR.INVV.* 21 + BKAR.TXN.* 13 + IS.EST.* 58 + ISFS.PS.* 24 + ISSR.INFO/MMS 52 + MTRO.* 47 | 2026-06-22 |
