...
| Database Schema (structure) | **94** | 95 | **1** ↑+4 Pass108: tier10+tier11 — 160+ tables across 16 families now documented. Key patterns: EvoERP archive pattern documented (every module has BKARINV/BKARINVL clones: ISAR*/ISSR*/ISRM*/ISSS*); ISSR_INFO 54f shared service record pattern identified across 9 tables; MK* campaign management structure; SUM* SA aggregations; ISGL* 14-period fiscal calendar; ISAP* AP archive with ISAPAINL(390f) largest AP table; ISPR* WO labor auth (ISPREQ); ISPOTRK carrier tracking; ISSO* packing/approval (ISSOBOX+ISSOREVU) | 2026-06-18 |
