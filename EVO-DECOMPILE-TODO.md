...
- [x] 🔄 **VSCHED** — Visual Work Center Capacity Scheduler (T7VSCHED: 94 procs); Pass 43: WCTRLOAD(8f) schema extracted: WC_LOAD_WC(12)+DATE(4) PK + TOTHRS+UDATE+CAP+UTIL+LOAD+EXTRA(100); opens WORKORD+WOROUT+WCTRLOAD+BKARINV+BKARINVL+BKICMSTR+FILELOC; WCTRLOAD = pre-computed WC capacity snapshot; BKARINV overlay = customer demand; purpose confirmed = visual/Gantt WC capacity planning — **C: 62/100**
