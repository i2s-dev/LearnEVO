...
- [x] 🔄 **SL** — Shop Loading / Sales Forecast (T7SLSFC: 5 procs); opens BKARINVL+BKDCLAB+BKARCUST+ISWOPRIO+WORKCTR+ROUTING — not a simple sales forecast; overlays AR demand on production capacity (work centers+routing) with DC labor and WO priority; shop loading display tool — **C: 48/100**
...
- [x] 🔄 **AL** — Audit Log + Alternate Parts (T7ALOGSETUP: 43 procs, FILELOC+BKSYMSTR+BKPSUSER — configures which tables/events go to audit log, per-user; T7ALTPART: 104 procs, BKSBPART+BKICMSTR+ISACCESS — alternate/substitute part number maintenance; BKSBPART(5f)=PARNT+PROD+CUST+SUBST); 2 programs identified — **C: 52/100**
...
- [x] 🔄 **ML** — Multi-Language Invoice Support (T7MLC: 50 procs); opens LANGDICT+BKARINV+BKARINVL+ISREPORD+BKGLTRAN+ISREPLNK+BKPRSALE+BKICPMAT+ISJAVA+BKEDMSTR+ISBSF; translates invoices via LANGDICT, applies pricing (BKICPMAT), posts GL (BKGLTRAN), integrates EDI (BKEDMSTR) and email (ISJAVA) — **C: 55/100**
...
| Module: QC/Quality Control | **72** | 75 | **3** ↑+7 | 2026-06-17 |
| Module: QT/Service Quote | **45** | 60 | **15** NEW | 2026-06-17 |
...
| Subsystem: AU/Automation | **62** | 68 | **6** ↑+10 | 2026-06-17 |
...
| Subsystem: LG/LGS Custom | **52** | 55 | **3** ↑+17 | 2026-06-17 |
...
| Module: SD/Standard Detail | **58** | 65 | **7** ↑+16 | 2026-06-17 |
| Module: SL/Shop Loading | **48** | 60 | **12** NEW | 2026-06-17 |
| Module: AL/Audit Log+AltPart | **52** | 65 | **13** NEW | 2026-06-17 |
| Module: ML/Multi-Language | **55** | 65 | **10** NEW | 2026-06-17 |
| Module: MH/Shipping Order | **55** | 65 | **10** NEW | 2026-06-17 |
| Module: BR/Brands | **48** | 60 | **12** NEW | 2026-06-17 |
| Module: NE/New Company Init | **55** | 65 | **10** NEW | 2026-06-17 |
| Module: JO/Jobs+Departments | **52** | 65 | **13** NEW | 2026-06-17 |
