...
- [x] 🔄 **DS** — Data Sync (22+ programs: T7DSAP/AR/BOM/CK/CM/CO/CS/DC/EST/FO/GEN/GL/HH/IC/IM/MRP/PO/PR/QC/RMA/RO/SH/SO/WC/WO); all share ISDROP(4f: CODE+TEXT+DESC+EXTRA) as sole module-specific table; ISDROP = operation code lookup/dropdown (not a data queue); actual sync target tables NOT in DB fingerprints — sync uses unregistered DDF connections or TAS runtime functions bypassing named-table fingerprinting; one program per module for external data synchronization — **C: 48/100** (ISDROP confirmed; sync logic and target system fully blocked by encryption)
...
| Subsystem: DS/Data Sync stubs | **48** | 65 | **17** ↑+6 Pass59 | 2026-06-17 |
