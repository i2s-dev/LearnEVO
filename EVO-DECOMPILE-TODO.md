...
| Database Schema (structure) | **92** | 95 | **3** ↑+2 Pass108: tier10-tables.md created — 8 undocumented families (77 tables) now documented: MK* marketing automation (11t: MKTRACK/TROUT/EVENT/FORM/ASSIGN/AHIST/DEF+code tables), SUM* SA summaries (4t), ISAR* AR archive (30t — BKARINV/BKARCUST clones with pattern analysis), BKAB* license (2t: START/EXP/PERIOD/WARNING+SERIAL/REG_NAME), ISAC* corrective action CAR/NCR (3t: IS_NCR/CARFU/ACTION), ISGL* extended GL (6t: COA+budget+forecast+14-period fiscal calendar), WO history (11t: WOHBOM/DATE/EXCH/LABOR/MAT/RECV/ROUT+WOROUT/WOROUTMP/WOROCHG), ISSE* service equipment (10t: ISSESH/ISSEDH=BKARINV clones, ISSERIAL/ISSERR WO serial tracking) | 2026-06-18 |
| Database Schema (field meaning) | **87** | 88 | **1** ↑+1 Pass108: tier10 adds field-level semantics for 77 tables — MK* campaign structure (MKAHIST+MKASSIGN+MKTROUT event sequences); SUM* aggregation meaning; ISAR* archive pattern documented; BKAB* license dates semantics; ISAC* CAR/NCR fields; ISGL* 14-period fiscal calendar (ISGLDATE_CYDATE_1..14 = period-end dates); WO history field meanings; ISSE* service invoice = BKARINV clone + serial tracking | 2026-06-18 |
