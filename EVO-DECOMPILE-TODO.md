...
- [x] 🔄 **FO** — Features & Options — 5 programs: T7FOA/B(5p stubs), T7FOC(60p BKBMMSTR+BKICMSTR — option entry), T7FOD(103p item+class range filter), T7FOE(86p item filter); BKFOCFG(18f: MANFET+YN_1..15+OPCODE) is the FO config table; BKBMMSTR(26f fully extracted Pass 64: PARENT+COMPONENT PK, QTY/LEAD/SCRAP/YIELD, PROD_OPYN_1..6 flags activate BOM line per FO option 1–6, REVISION/NOTES/EXTRA); PROD_OPYN_1..6 mechanism fully decoded — **C: 72/100**
...
- [x] 🔄 **TA** — TAS / System Administration — CHM confirmed 9 ops: TA-D=Maintain Database, TA-G=Maintain Menu Access Records, TA-H=Maintain Menu End User, TA-M=Forms Editor, TA-N=Program Scheduler, TA-O=Backup Utility, TA-Q=Change Logo Image, TA-R=SQL Editor, TA-S=Data Dictionary Check; 5 programs matched: TA-S=T7DDCHECK (92p, FILEDICT+FILEKEY+FILELOC), TA-N=EVOSCHEDULER (65p, ISSCHED) + EVOSCHEDSETUP (37p), TA-O=EVOERPBACKUP (76p, zipdll), TA-R=QUERYEXECUTE (26p, ISDRILL); TA-D likely T7FNR (104p, file browser); Pass 63: 8 WTAS* TAS Admin programs confirmed: WTASDATAM(59p)+WTASDMGR(68p) data managers, WTASFLOC(22p)+WTASMERGE(16p) file location managers, WTASINIT(21p)+WTASCVTDICT(13p)+WTASCVTDICTPR(12p) dict converters, WTASCHKINT(8p) integrity check; all operate on FILE* runtime tables (FILELOC+FILEDICT+FILEKEY+FILEKNUM+FILEDES+FILEDFLD+FILEDBF+ERRMSG); FILE* tables explain why FILELOC appears as non-DDF in hundreds of EVO programs; TA-G/H/M/Q still unmatched — **C: 72/100**
...
| Module: IC/Inventory Utility | **68** | 72 | **4** ↑+13 Pass59 | 2026-06-17 |
...
| Module: FO/Features Options | **72** | 72 | **0** ✅ ↑+7 Pass64 | 2026-06-17 |
...
| Module: TA/TAS Admin | **72** | 72 | **0** ✅ ↑+7 Pass63 | 2026-06-17 |
...
| Module: AL/Audit Log+AltPart | **65** | 72 | **7** ↑+3 Pass57 | 2026-06-17 |
...
| Module: JO/Jobs+Departments | **65** | 72 | **7** ↑+3 Pass57 | 2026-06-17 |
