...
- [x] 🔄 All remaining IS\* tables — Pass 134 (2026-06-19) adds: ISIS(23f: global feature flags — TAX/MULTI_CURR/LANDED_COST/UPC/IMAGING/EZPAY/RMA/SPEC_SUP), ISBANKS(23f: bank master — GLA/GLD/BAL/ROUT/ACCT/CURR/TYPE/5×RTM), ISBSF(143f: Business Score KPI — AR/AP/SO/PO/WO/IC + 9 cash-act + 100 period history), ISBTCSB(54f: batch service ISSR_INFO clone), ISBILLSH(4f), ISBINLOC(9f: bin qty), ISBINLOT(10f: bin-lot qty+TMP), MK* family (11 tables) documented in tier2-tables.md; prior: ISLBLMAP(102f)/IS2DBAR(109f)/ISSCHED(24f)/ISNOTES(13f)/ISSRMMS(12f)/ISSRINFO(54f)/ISSOREVU(12f)/ISARINVX(4f)/ISSDET(4f)/ISORDECO(13f)/ISNTYPE(4f)/ISUDFINV(8f)/ISARTXNB(23f); ~200 IS\* still unread — **C: 58/100**
