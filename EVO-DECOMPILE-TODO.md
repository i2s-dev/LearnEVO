...
| Module: IN/Inventory | **96** | 85 | **0** ✅ Pass170 T7INB(466p): BKIC.PROD.*(63)+LOC.*(33+11new)+LOCM.*(15)+REF.*(12new) + MTIC.PROD.*(57) + MTIT.*(34/INVTXN) + MTOOL.*(39/mold) + MTWC.*(30) + ISCC.ICM.*(53/upholstery custom) | 2026-06-22 |
