"""
Extract field names from Java table model classes in EvoPVT.jar (sql/tables/ subdir).
"""
...
tables_dir = r'C:\Users\tsinclair.I2SYSTEMS\Documents\Visual Studio Code Projects\LearnEVO\samples\jar\extracted\com\evoerp\sql\tables'
...
for tname in sorted(targets):
    fpath = os.path.join(tables_dir, tname + '.class')
